...
import { Mic, Calendar, Download, CheckCircle, Quote, ChevronRight, Target } from 'lucide-react';
          ...
          <div className="grid-2">
            ...
            <div className="card">
              ...
              <ul className={styles.bulletList}>
                <li><CheckCircle size={16} className="text-accent" /> Demystify quantum-ready AI systems.</li>
                <li><CheckCircle size={16} className="text-accent" /> Roadmap for smart airports and neuroadaptive cities.</li>
                <li><CheckCircle size={16} className="text-accent" /> ROI and scalability in autonomous infrastructure.</li>
              </ul>
            </div>
            ...
            <div className="card">
              ...
              <ul className={styles.bulletList}>
                ...
                <li><CheckCircle size={16} className="text-accent" /> Implementing automated bias detection pipelines.</li>
                <li><CheckCircle size={16} className="text-accent" /> Balancing rapid innovation with compliance and trust.</li>
              </ul>
            </div>
            ...
            <div className="card">
              ...
              <ul className={styles.bulletList}>
                <li><CheckCircle size={16} className="text-accent" /> Exploring the bleeding-edge of bio-inspired robotics.</li>
                <li><CheckCircle size={16} className="text-accent" /> Ethical frameworks for advanced autonomous manipulation.</li>
                <li><CheckCircle size={16} className="text-accent" /> Cross-industry applications from healthcare to logistics.</li>
              </ul>
            </div>
            ...
            <div className="card">
              ...
              <ul className={styles.bulletList}>
                <li><CheckCircle size={16} className="text-accent" /> Integrating AI into academic curricula and corporate training.</li>
                <li><CheckCircle size={16} className="text-accent" /> Preparing the workforce for human-AI collaboration.</li>
                <li><CheckCircle size={16} className="text-accent" /> 360&deg; VR and simulated environments for skill acquisition.</li>
              </ul>
            </div>
          ...
          <div className={styles.workshopList}>
            <div className={styles.workshopCard}>
              ...
              <div className="bg-dark p-4 rounded mb-4" style={{ borderLeft: '3px solid var(--accent)', paddingLeft: '24px' }}>
                <h4 className="text-sm uppercase tracking-wider mb-3" style={{ color: 'var(--accent)', opacity: 0.9 }}>Sample Agenda</h4>
                <ul className={styles.bulletList}>
                  <li className="mb-2"><ChevronRight size={16} className="text-muted" /> <strong>Morning:</strong> AI Capability Mapping &amp; Competitive Analysis</li>
                  <li className="mb-2"><ChevronRight size={16} className="text-muted" /> <strong>Afternoon:</strong> Risk Mitigation, Ethical Governance &amp; ROI Modeling</li>
                  <li className="mt-3 pt-3" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}><Target size={16} className="text-accent" /> <strong className="text-accent">Outcome:</strong> A customized 12-month AI pilot roadmap.</li>
                </ul>
              </div>
            </div>
            ...
            <div className={styles.workshopCard}>
              ...
              <div className="bg-dark p-4 rounded mb-4" style={{ borderLeft: '3px solid var(--accent)', paddingLeft: '24px' }}>
                <h4 className="text-sm uppercase tracking-wider mb-3" style={{ color: 'var(--accent)', opacity: 0.9 }}>Sample Agenda</h4>
                <ul className={styles.bulletList}>
                  <li className="mb-2"><ChevronRight size={16} className="text-muted" /> <strong>Day 1:</strong> Re-evaluating Assessments &amp; Teaching in the GenAI Era</li>
                  <li className="mb-2"><ChevronRight size={16} className="text-muted" /> <strong>Day 2:</strong> Institutional Policy, Ethics, &amp; Faculty Training Frameworks</li>
                  <li className="mt-3 pt-3" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}><Target size={16} className="text-accent" /> <strong className="text-accent">Outcome:</strong> Comprehensive institutional guidelines for AI adoption.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="grid-2 align-center">
            <div>
              ...
              <ul className={`${styles.bulletList} mb-8`}>
                <li className="mb-3"><CheckCircle size={16} className="text-accent" /> Global availability (subject to schedule)</li>
            ...
            <div className="card text-center bg-dark" style={{ padding: '40px' }}>
              ...
              <p className="text-muted mb-6" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>Let&apos;s discuss how we can tailor a keynote or workshop to your precise organizational objectives.</p>
              <Link href="/contact?interest=speaking" className="btn btn-primary w-full block" style={{ padding: '16px 0', fontSize: '1.1rem' }}>Check Availability</Link>
            </div>
          </div>
        </div>
      </section>
